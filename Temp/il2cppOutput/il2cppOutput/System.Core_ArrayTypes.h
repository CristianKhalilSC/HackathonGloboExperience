...
#include "System_Core_System_Collections_Generic_HashSet_1_L3147403209.h"
...
struct LinkU5BU5D_t262484724  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) Link_t3147403209  m_Items[1];

public:
	inline Link_t3147403209  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Link_t3147403209 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, Link_t3147403209  value)
	{
		m_Items[index] = value;
	}
};
